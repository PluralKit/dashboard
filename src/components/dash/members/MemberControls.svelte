<script lang="ts">
  ...
  import { IconAdjustments, IconSettings, IconUserQuestion, IconUsers } from "@tabler/icons-svelte"
...
<div class="text-sm mt-2">
      ...
      |
      <a href={`/dash/${dash.system?.id}/random?tab=members`} class="link-secondary">
          Random Members
        </a>
    </div>
<ListControls bind:list {wide} />
{#if simpleOnly || list.settings.filterMode === "simple"}
  <SimpleMemberControls {groupList} {list} {wide} />
